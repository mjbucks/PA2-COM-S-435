...
//        }
        ...
        ArrayList<Integer> A = new ArrayList<Integer>(List.of(1, 2, 2, 2, 2));
        ArrayList<Integer> B = new ArrayList<Integer>(List.of(1, 2));
        JaccardSimilarity<Integer> jaccSim = new JaccardSimilarity<>();
        System.out.println(jaccSim.MultiSetJaccardSimilarity(A, B));
